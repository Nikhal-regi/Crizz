      ...
      <div className="grid grid-cols-6 gap-2 mb-6">
        {[0, 1, 2, 3, 4, 6].map((run) => (
          <button
            ...
            className={`py-2 text-lg font-semibold rounded-lg border transition-colors duration-200 ${
      ...
      <div className="grid grid-cols-5 gap-2 mb-6">
        {["Wicket", "Wide", "No Ball", "Leg Bye", "Bye"].map((type) => (
          <button
            ...
            className={`py-2 text-sm font-semibold rounded-lg border transition-colors duration-200 ${
